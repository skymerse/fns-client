...
public class NotamUtilsTest {
    private static final String TEST_AIXM_NOTAM = "<ns13:AIXMBasicMessage ns5:id=\"FNS_ID_75742039\" xmlns:ns1=\"http://www.opengis.net/ows/1.1\" " +
    ...
    @Test
    public void testExtractIcaoMessage() throws JAXBException {
        String result = NotamUtils.extractIcaoMessage(TEST_AIXM_NOTAM);
